  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#030303] px-6 pt-24">
      ...
      >
        ...
        >
          Hi, I'm <strong className="text-white font-semibold">Jithin Jayakumar Sheela</strong>, a developer, builder, and founder of <span className="text-indigo-400 font-semibold">Blakmarket</span>. Working alongside advanced AI agents to ship blazing-fast web apps deployed on Netlify.
        </motion.p>
        ...
        {/* Stats / Interactive panel showcase */}
        <motion.div
          variants={itemVariants}
        ...
        >
          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm hover:border-white/10 transition-all">
            <h3 className="text-white font-semibold text-base mb-2">⚡ Modern Stack</h3>
            <p className="text-sm text-gray-400">Next.js 16 App Router, React 19, Tailwind CSS v4, and Framer Motion.</p>
          </div>
          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm hover:border-white/10 transition-all">
            <h3 className="text-white font-semibold text-base mb-2">🤖 Agent Integrated</h3>
            <p className="text-sm text-gray-400">Built using Antigravity AI agent, complete with custom `.mdc` rules and Netlify MCP tools.</p>
          </div>
          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm hover:border-white/10 transition-all">
            <h3 className="text-white font-semibold text-base mb-2">☁️ Serverless Edge</h3>
            <p className="text-sm text-gray-400">Optimized deploy on Netlify with Edge function API layer and Database primitives.</p>
          </div>
        </motion.div>
      </motion.div>
    </section>
